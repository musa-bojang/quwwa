...
<head>
	<meta charset="utf-8" />
	<title> Login Options - Login Form</title>
...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="model/authenticate.php" method="post">
		
			<h3 class="form-title">Log Masuk Akaun</h3>
			<span class="help-inline" id="user-availability-status"></span>
			 <?php 
			...
			<div>
				...
				<p>
					 Klik link <a href="permohonan_baru.html" >permohonan</a>
					untuk mendaftar permohonan baharu.
				</p>
			</div>
			<div class="forget-password">
				<h4>Terlupa Katalaluan ?</h4>
				<p>
					Klik <a href="javascript:;"  id="forget-password">di sini</a>
					untuk menukar katalaluan.
				</p>
			</div>
